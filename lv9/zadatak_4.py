...
def learn(name, batch_size = 64, optimizer = 'adam', use_small_model = False, use_small_dataset = False):
    print(name)
...
learn("base_line")
learn("small_batch", batch_size=32)
# learn("different_learning_rate", optimizer='adamax')
# learn("less_layers", use_small_model=True)
# learn("small_dataset", use_small_dataset=True)
