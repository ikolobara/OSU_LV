...
'''
ako je k = 1 dolazi do prenaucenosti;
ako je k = 100 dolazi do podnaucenosti
'''
...
'''
manji C i gamma dovode do podnaucenosti;
veci C i gamma dovode do prenaucenosti;
razliciti kerneli daju razlicitu granicu odluke (oblik, kompleksnost)
'''
